...
static const uint256 hashGenesisBlockOfficial("0xea6f294bf01e6b459563108bc1d3b2cdd1dcb352227d4ae8723e9bc3428dc1f5");
static const uint256 hashGenesisBlockTestNet ("0x00000ffd590b1485b3caadc19b22e6379c733355108f107a430458cdf3407ab6");
...
public:
    ...
    {
        // falcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // falcoin: get transaction coin age
...
public:
    ...
    // falcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // falcoin: entropy bit for stake modifier if chosen by modifier
    ...
    // falcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // falcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // falcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // falcoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // falcoin: block index flags
    enum
    {
